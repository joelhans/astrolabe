  ...
  return (
    <>
      ...
      <div className="space-y-20 divide-y divide-gray-200 dark:divide-gray-700">
        <div className="flex px-8 pt-32 pb-16 bg-erin bg-opacity-10">
          <div className="w-1/2 pr-4">
            ...
            <p className="max-w-screen-lg text-lg md:text-2xl font-medium leading-9 text-gray-700 dark:text-gray-400 mb-8">
              A microscopic hardware, system, container, service, and application monitoring Agent
              for Linux servers. Open-source, free, preconfigured, opinionated, and always
              real-time.
            </p>
            <div className="flex flex-wrap space-y-4 sm:space-y-0 sm:space-x-4 text-center">
              <button
                type="button"
                className="w-full sm:w-auto flex-none bg-gray-50 text-xl text-gray-400 hover:text-gray-900 font-mono leading-6 py-4 sm:px-6 border border-gray-200 rounded-sm flex items-center justify-center space-x-2 sm:space-x-4 focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-gray-300 focus:outline-none transition-colors duration-200"
              >
        ...
        <div className="">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl leading-none font-extrabold tracking-tight text-gray-800 mb-7 sm:mb-8">
