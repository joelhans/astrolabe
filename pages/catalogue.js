      ...
      <main className="max-w-screen-lg mx-auto mb-auto px-6">
        <header className="mt-48">
          ...
          <p className="text-lg md:text-xl mt-8">
            The Catalogue is another way of accessing the works of <em>Astrolabe</em>, particularly
            for accessibility purposes. Look through the list or search via a piece's name, author,
            or asterism.
          </p>
        </header>
