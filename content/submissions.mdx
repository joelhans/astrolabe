...
title: Submissions
summary: >-
  Astrolabe is closed for submissions while we prepare for the Universe to materialize. Submissions open on December 21, 2022.
declination: 1.4
ascension: 6
size: 20
color: '#059669'
...
<Submissions state={false} />

Astrolabe will open for submissions on the **winter solstice, December 21, 2022**, to celebrate the Universe as it
materializes for the first time.
