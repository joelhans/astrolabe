...
draft: false
summary: Write more inspiring and impactful copywriting—just like a professional copywriter—with this no-nonsense copywriting checklist.
...
<div class="checklist-pull checklist-pull-info lg:absolute">
  <div class="inner">
    <p class="m-0">
      Be sure to check items off the checklist as you go! You can find helpful checkboxes{' '}
      <span class="hidden lg:inline-block">in this sidebar</span>
      <span class="inline-block lg:hidden">beneath each item</span> and at the <a href="#the-complete-checklist">
        end of the post
      </a>. They'll even sync up so you can have it both ways!
    </p>
  </div>
</div>
...
<span class="text-green font-bold">
  *Proofish* creates social proof for your website and increases trust so more visitors turn into
  customers, and your revenue grows.
</span>

Why?

<span class="text-green font-bold">
  *Proofish* creates social proof for your website and increases trust with automated tools so more
  visitors turn into customers and your revenue grows—without any extra work on your part.
</span>

Go deeper.

<span class="text-green font-bold">
  *Proofish* is social proof automation to boost traffic, trust, and conversions without any extra
  work on your part.
</span>
...
<div class="" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      ...
      <label for="general-2">
        I removed other generalist language in favor of verbiage that targets my ideal audience.
      </label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      ...
      <label for="jargon-2">
        I ensured that I'm speaking the same language as my target audience by talking about their
        problems in ways they immediately understand.
      </label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      ...
      <label for="key-1">
        I researched the most important and valuable keywords to my business based on past success
        and future goals.
      </label>
    </div>
    <div>
      ...
      <label for="key-2">
        I inserted keywords into my copy in a natural way that does not detract from readability.
      </label>
    </div>
    <div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      ...
      <label for="scan-4">
        If possible, I implemented sufficient white space around my copy to make it eye-catching.
      </label>
    </div>
  </div>
</div>
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      ...
      <label for="online-1">
        I ran my copy through Grammarly, Hemingway, or another spelling/grammar checker.
      </label>
    </div>
  </div>
</div>
  ...
  <div class="inner" markdown="1">
    ...
    <div>
      ...
      <label for="feedback-1">
        I sent my copy to one or more friends/colleagues/co-workers/a community and asked for
...
<div class="checklist-pull lg:absolute" markdown="1">
  <div class="inner" markdown="1">
    ...
    <div>
      ...
      <label for="action-1">
        I removed non-active sentences and replaced them with ones that help the customer see
        themselves taking action and creating change.
      </label>
    </div>
  </div>
</div>
...
<Aside>
  <h3>Remove wordiness that reduces conciseness or over-qualifies</h3>
...
<div class="checklist-final">
  <div class="inner">
    ...
    <div>
      ...
      <label for="jargon-1_final">
        I eliminated technical, audience-reducing jargon from my copy.
      </label>
    </div>
    <div>
      <input type="checkbox" id="jargon-2_final" name="jargon-2" />
      <label for="jargon-2_final">
        I ensured that I'm speaking the same language as my target audience by talking about their
        problems in ways they immediately understand.
      </label>
    </div>
    ...
    <div>
      ...
      <label for="word-1_final">
        I removed non-concise words like "really," "actually," and "very."
      </label>
    </div>
    <div>
    ...
    <div>
      ...
      <label for="super-1_final">
        I removed all superlatives unless I had conclusive proof that my company/product/solution
    ...
    <div>
      ...
      <label for="cliche-1_final">
        I removed clichés from my copywriting and replaced those phrases with fresh, exciting
        alternatives.
      </label>
    </div>
    ...
    <div>
      ...
      <label for="aloud-1_final">
        I read my work aloud and noted places where the syntax or flow was less than ideal.
      </label>
    </div>
    <div>
    ...
    <button class="checklist-clear button button-orange text-white p-2 mt-4">
      Clear the checklist, please!
    </button>
  </div>
</div>
