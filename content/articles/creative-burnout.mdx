...
updatedOn: '2021-10-07T15:48:59.275Z'
...
{/_ $10 {\ units\ of\ creativity} - 8 {\ full-time\ work} = 2 {\ remaining}$ _/}

The problem wasn't that the salary was too low for those `8 units`.

<Statement>
  The problem was that the salary wasn't enough to compensate me for what little I had left for
  myself.
</Statement>
...
{/_ $10 {\ units\ of\ creativity} - 5 {\ freelance\ work} = 5 {\ remaining}$ _/}
