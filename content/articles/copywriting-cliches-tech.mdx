...
draft: false
summary: Tech businesses love to borrow certain tired phrases when they talk about themselves. Here's some of my worst offenders in 2019 so you know what not to say.
...
<p className="!text-sea text-2xl font-medium">1. Let's continue to be honest about the ways we write. Through critique and self-examination, we can become better at the art of writing, whether it's a piece of fiction or a piece of web copy.</p>

<p className="!text-steel text-2xl font-medium">2. Let's aim for clarity. Many of these phrases create unnecessary complexity in favor of sounding different. It's not about using the fewest words possible. It's about creating the clearest message possible.</p>
