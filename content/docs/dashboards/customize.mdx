...
While the [Netdata dashboard](/docs/dashboards/dashboards-charts.mdx) comes preconfigured with hundreds of charts and
...
```javascript:title=dashboard_info.js
...
dashboards](/docs/dashboards/custom-dashboards.mdx) with HTML, CSS, and JavaScript.

### Further reading & related information

- [Web server reference](/docs/dashboards/reference-web-server.mdx)
